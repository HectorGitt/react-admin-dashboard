        ...
        >
          ...
          >
            <Box mt='25px' p='0 30px' display='flex' justifyContent='space-between' alignItems='center'>
              <Box>
                <Typography variant='h5' fontWeight='bold' color={colors.grey[100]}>Revenue Generated</Typography>
          ...
          >
            ...
            p='15px'
            >
              <Typography variant='h5' color={colors.grey[100]} fontWeight='600'>Recent Transactions</Typography>
